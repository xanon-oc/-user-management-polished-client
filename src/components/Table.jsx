...
const Table = ({ user }) => {
  const { _id, name, email, genderData, activeData } = user;
  return (
    <div>
      <tbody>
        <tr className="bg-blue-600 border-b border-blue-400">
          ...
          <td className="px-6 py-4">NILOY</td>
          <td className="px-6 py-4 bg-blue-500">niloyroy184@gmail.com</td>
          <td className="px-6 py-4">Male</td>
          <td className="px-6 py-4 bg-blue-500">
            <p className="font-medium text-white hover:underline">Active</p>
          </td>
